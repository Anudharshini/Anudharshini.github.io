...
@WebServlet("/GetPolicyDetail")
public class GetPolicyDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Integer> suc=GetPolicyDetailBO.checkParams(request.getParameter("customer_id"));
