	...
	<div align="center">
     ...
     %>
			<div class="container">
				...
				<h1>
					<font color="#fff">Pending Policy Details</font>
				</h1>
							...
							<td>
								<form action="Approve" method="post">
									<input type="hidden" name="id"
										...
										type="submit" class="approve form-control" value="Approve">
								</form></td>
							<td>
								<form action="Reject" method="post">
									<input type="hidden" name="id"
										value="<%=myentry.getValue().getPolicy_id() %>"> <input
										type="submit" class="reject form-control" value="Reject">
								</form></td>
						</tr>
						<%}}
else
{%>
						...
						<br>
						<h1>
							<font color="#fff">No Pending Policies</font>
						</h1>
						<br>
						<br>
						<br>
