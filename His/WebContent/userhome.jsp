...
<body id="load" onload="sessionvalidate()">
	...
	<div class="intro-header">
		...
		<div align="center">
			<p
				style="color: #fff; font-family: Orbitron; font-style: italic; font-size: 27px;">"Life
				is a one Time</p>
			<p
				style="color: #fff; font-family: Orbitron; font-style: italic; font-size: 27px;">Offer</p>
			<p
				style="color: #fff; font-family: Orbitron; font-style: italic; font-size: 27px;">Use
				it WELL"</p>
