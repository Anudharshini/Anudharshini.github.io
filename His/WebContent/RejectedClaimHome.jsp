...
<body id="load" onload="sessionvalidate()">
	...
	<div class="intro-header1">
		<div class="container">
			...
			<div class="row" align="right">
				...
				<ul class="nav navbar-nav navbar-center">
					...
					<li><a href="AdminHome">Pending Policies</a>
                              ...
                              <li><a href="ViewClaim">Pending Claims</a></li>
				</ul>
			</div>
			...
			<%
				Map<Integer, ClaimBean> empmap = (Map<Integer, ClaimBean>) request.getAttribute("rejectclaim");
					if(!empmap.isEmpty()){
			%> 
			<div class="container">
				<!-- <div class="row" align="center"> -->
					...
					<h1>
						<font color="#fff">Rejected Claim Details</font>
					</h1>
...
{%>
							...
							<br>
							<h1>
								<font color="#fff">No Rejected Claims</font>
							</h1>
							<br>
							<br>
							<br>
